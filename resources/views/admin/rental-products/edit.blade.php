...
<div class="container mx-auto px-4 py-8">
    ...
    <form action="{{ route('admin.rental-products.update', $rentalProduct) }}" method="POST" class="max-w-2xl">
        @csrf
        @method('PUT')

        <div class="mb-4">
            <label for="name" class="block text-gray-700 text-sm font-bold mb-2">Название товара</label>
            <input type="text" name="name" id="name" value="{{ old('name', $rentalProduct->name) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="number" step="0.01" name="price" id="price" value="{{ old('price', $rentalProduct->price) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <div id="sizes-container">
                ...
                <div class="flex gap-4 mb-2">
                    ...
                    <input type="number" name="quantities[]" min="1" value="{{ $quantity }}" class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Количество">
