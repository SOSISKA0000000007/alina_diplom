...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <form action="{{ route('admin.rental-products.store') }}" method="POST" class="max-w-2xl" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-4">
                <label for="images" class="block text-gray-700 text-sm font-bold mb-2">Фотографии (можно выбрать несколько)</label>
            ...
            <div class="mb-4">
                ...
                <div id="sizes-container">
                    <div class="flex gap-4 mb-2">
                        ...
                        <input type="number" name="quantities[]" min="1" class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Количество" value="{{ old('quantities.0') }}">
