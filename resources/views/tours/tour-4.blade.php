...
@section('content')
    <div class="container">
        <h2 class="program-h2">Программа погружения "Ледокол Поллукус"</h2>
        <!-- Program Section -->
        <section class="program">
            <div class="program-wrapper">
                ...
                <p>Одним из главных впечатлений станет погружение к затонувшему в 1907 году кораблю «Ледокол Поллукус» — редкая возможность прикоснуться к истории в формате подводного приключения.</p>
            ...
            <div class="video-container">
                <video width="740" controls autoplay muted>
                    <source src="{{ asset('videos/tour-4.mp4') }}" type="video/mp4">
